...
::: danger ⚠️ 射频合规警告 - 开始配置前必读！
在配置和启动 gNB 进行无线电发射之前，请确保你已经：

1. ✅ 阅读了 [法律法规与合规要求](/guide/rf-regulations)
2. ✅ 准备好了**射频屏蔽箱**或**线缆直连+衰减器**
3. ✅ 了解非法发射的法律后果（5-15日拘留）

如果你只是想测试软件功能，可以使用 ZMQ 仿真模式，无需连接 SDR 硬件。
:::
...
::: warning ⚠️ 即使低功率也需要屏蔽！
即使将 `tx_gain` 设置为很低的值，信号仍然可能泄漏并干扰周围的蜂窝网络。**请务必使用射频屏蔽箱！**
:::
...
::: tip ✅ 无需担心法规问题
ZMQ 模式不使用实际 SDR 硬件，不产生无线电发射，可以安全地进行软件测试和学习。**强烈推荐初学者先使用此模式**。
:::
